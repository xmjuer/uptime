...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    {
      id: 'cilicili666-cilicili666.hf.space',
      name: 'CPA-clicli',
      method: 'GET',
      target: 'https://cilicili666-cilicili666.hf.space',
      tooltip: 'CPA-clicli',
      statusPageLink: 'https://cilicili666-cilicili666.hf.space',
      hideLatencyChart: true,
      expectedCodes: [200,301,302],
      timeout: 10000,
      headers: {
    ...
    {
      id: 'gy669-gy669.hf.space',
      name: '关羽webdav',
      method: 'GET',
      target: 'https://gy669-gy669.hf.space',
      tooltip: '关羽webdav',
      statusPageLink: 'https://gy669-gy669.hf.space',
      hideLatencyChart: true,
      expectedCodes: [200,301,302],
      timeout: 10000,
      headers: {
